...
<b style='font-size: 15px;'>Welcome! This function generates configuration for VLESS protocol. If you find this useful, please check our GitHub project for more:</b>
<b style='font-size: 15px;'>Welcome! This is the configuration that generates the VLESS protocol. If you find this project useful, please check out our GitHub project and give me a star:</b>
<a href='https://github.com/3Kmfi6HP/EDtunnel' target='_blank'>EDtunnel - https://github.com/3Kmfi6HP/EDtunnel</a>
<iframe src='https://ghbtns.com/github-btn.html?user=USERNAME&repo=REPOSITORY&type=star&count=true&size=large' frameborder='0' scrolling='0' width='170' height='30 ' title='GitHub'></iframe>
<a href='//${hostName}/sub/${userIDArray[0]}' target='_blank'>VLESS node subscription connection</a>
<a href='clash://install-config?url=${encodeURIComponent(`https://${hostName}/sub/${userIDArray[0]}?format=clash`)}}' target=' _blank'>Clash for Windows node subscription connection</a>
<a href='${clash_link}' target='_blank'>Clash node subscription link</a>
<a href='${subbestip}' target='_blank'>Preferred IP automatic node subscription</a>
<a href='clash://install-config?url=${encodeURIComponent(subbetip)}' target='_blank'>Clash preferred IP automatically</a>
<a href='sing-box://import-remote-profile?url=${encodeURIComponent(subbetip)}' target='_blank'>singbox preferred IP automatically</a>
<a href='sn://subscription?url=${encodeURIComponent(subbetip)}' target='_blank'>nekobox preferred IP automatically</a>
<a href='v2rayng://install-config?url=${encodeURIComponent(subbestip)}' target='_blank'>v2rayNG preferred IP automatically</a></p>`;
